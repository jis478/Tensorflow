...
Original file is located at
    https://colab.research.google.com/drive/1xBfbn35tJWg_1faSwN09puBQEykLP-T-
"""
  ...
  for epoch in range(args.epochs):
    ...
    for image, target in train_dataset: 
      ...
      if args.beta > 0 and r < args.cutmix_prob:
          ...
          mask = np.ones_like(image.shape)
          image_a = image
          image_b = tf.gather(image, rand_index)
          mask = np.ones_like(image)
          mask[:, bbx1:bbx2, bby1:bby2, :] = 0            
          # mask = tf.conver_to_tensor(mask)                   
...
print('Best accuracy (top-1 and 5 error):', best_err1.numpy(), best_err5.numpy())
