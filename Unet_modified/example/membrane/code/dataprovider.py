...
class Tfrecord_ImageDataProvider():
    def __init__(self, train_tfrecord_path=None, test_tfrecord_path=None, channels=1, train_batch_size=4,
                 test_batch_size=16, nx=256, ny=256, n_imgs=40):
    ...
    def build_get_data(self):
        ...
        self.train_dataset = self.train_dataset.shuffle(buffer_size=(int(self.n_imgs) * 2 + 3 * self.train_batch_size))
        ...
        self.test_dataset = self.test_dataset.shuffle(buffer_size=(int(self.n_imgs) * 2 + 3 * self.test_batch_size))
